...
class RestoreVARAgent(BaseAgent):
    def __init__(self):
        super().__init__("RestoreVAR")
    ...
    def load_model(self):
        from temp.RestoreVAR.models.restorevar import RestoreVAR  # Assuming model file in repo
        model = RestoreVAR()
        path_weights = 'weights/restorevar.pth'  # TODO: Download weights

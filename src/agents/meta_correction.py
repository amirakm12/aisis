...
class MetaCorrectionAgent(BaseAgent):
    ...
    async def _initialize(self) -> None:
        ...
        try:
            ...
            # Consistency checker
            self.models["consistency_checker"] = (
                await self._load_consistency_checker()
            )
    ...
    async def _process(self, task: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "critique": (
                    critique.tolist() if critique is not None else None
                ),
                "needs_correction": needs_correction,
                "correction_applied": correction_applied,
                "consistency_score": float(consistency_score),
                "error_map": (
                    error_map.tolist() if error_map is not None else None
                ),
            }

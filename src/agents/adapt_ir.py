...
class AdaptIRAgent(BaseAgent):
    def __init__(self):
        super().__init__("AdaptIR")
    ...
    def load_model(self):
        from temp.AdaptIR.models.adaptir import AdaptIR  # Assuming model file
        model = AdaptIR()
        path_weights = 'weights/adaptir.pth'  # TODO: Download from repo

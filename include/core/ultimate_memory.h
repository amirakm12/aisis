 ...
 * @date 2024
 * 
 * Memory management functionality for the ULTIMATE embedded system.
...
/* Cache management */
void ultimate_memory_cache_clean(void* addr, size_t size);
void ultimate_memory_cache_invalidate(void* addr, size_t size);
void ultimate_memory_cache_clean_invalidate(void* addr, size_t size);

/* DMA coherent memory */
void* ultimate_dma_alloc_coherent(size_t size);
void ultimate_dma_free_coherent(void* ptr, size_t size);

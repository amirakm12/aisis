 ...
 * inter-task communication, and system services.
 */
...
typedef void (*ultimate_isr_t)(void);

ultimate_error_t ultimate_interrupt_register(uint32_t irq_number,
                                            ultimate_isr_t isr,
                                            uint32_t priority);
ultimate_error_t ultimate_interrupt_unregister(uint32_t irq_number);
ultimate_error_t ultimate_interrupt_enable(uint32_t irq_number);
ultimate_error_t ultimate_interrupt_disable(uint32_t irq_number);

 ...
 * @date 2024
 * 
 * Comprehensive error code definitions and error handling functionality.
 */
...
/* Hardware error codes (500-599) */
#define ULTIMATE_ERROR_GPIO_INIT_FAILED     500
#define ULTIMATE_ERROR_GPIO_CONFIG_FAILED   501
#define ULTIMATE_ERROR_GPIO_READ_FAILED     502
#define ULTIMATE_ERROR_GPIO_WRITE_FAILED    503
#define ULTIMATE_ERROR_UART_INIT_FAILED     504
#define ULTIMATE_ERROR_UART_CONFIG_FAILED   505
#define ULTIMATE_ERROR_UART_TX_FAILED       506
#define ULTIMATE_ERROR_UART_RX_FAILED       507
#define ULTIMATE_ERROR_SPI_INIT_FAILED      508
#define ULTIMATE_ERROR_SPI_TRANSFER_FAILED  509
#define ULTIMATE_ERROR_I2C_INIT_FAILED      510
#define ULTIMATE_ERROR_I2C_TRANSFER_FAILED  511
#define ULTIMATE_ERROR_ADC_INIT_FAILED      512
#define ULTIMATE_ERROR_ADC_READ_FAILED      513
#define ULTIMATE_ERROR_PWM_INIT_FAILED      514
#define ULTIMATE_ERROR_PWM_CONFIG_FAILED    515

/* Neural system error codes (600-699) */
#define ULTIMATE_ERROR_NEURAL_INIT_FAILED   600
#define ULTIMATE_ERROR_NEURAL_MODEL_INVALID 601
#define ULTIMATE_ERROR_NEURAL_INPUT_INVALID 602
#define ULTIMATE_ERROR_NEURAL_OUTPUT_INVALID 603
#define ULTIMATE_ERROR_NEURAL_COMPUTE_FAILED 604
#define ULTIMATE_ERROR_NEURAL_MEMORY_ERROR  605
#define ULTIMATE_ERROR_NEURAL_CALIBRATION_FAILED 606

/* File system error codes (700-799) */
#define ULTIMATE_ERROR_FS_NOT_MOUNTED       700
#define ULTIMATE_ERROR_FS_MOUNT_FAILED      701
#define ULTIMATE_ERROR_FS_FILE_NOT_FOUND    702
#define ULTIMATE_ERROR_FS_FILE_CREATE_FAILED 703
#define ULTIMATE_ERROR_FS_FILE_READ_FAILED  704
#define ULTIMATE_ERROR_FS_FILE_WRITE_FAILED 705
#define ULTIMATE_ERROR_FS_DISK_FULL         706
#define ULTIMATE_ERROR_FS_PERMISSION_DENIED 707

/* Network error codes (800-899) */
#define ULTIMATE_ERROR_NET_NOT_CONNECTED    800
#define ULTIMATE_ERROR_NET_CONNECTION_FAILED 801
#define ULTIMATE_ERROR_NET_SEND_FAILED      802
#define ULTIMATE_ERROR_NET_RECEIVE_FAILED   803
#define ULTIMATE_ERROR_NET_TIMEOUT          804
#define ULTIMATE_ERROR_NET_INVALID_ADDRESS  805

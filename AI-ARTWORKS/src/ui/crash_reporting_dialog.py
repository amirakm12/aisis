...
from src.core.config_validation import AI_ARTWORKConfig, ValidationError
import json
...
class CrashReportingDialog(QDialog):
    def __init__(self, config, parent=None):
        ...
        self.label = QLabel("Help us improve AI-ARTWORK by sending anonymous crash reports.")
    ...
    def import_settings(self, path):
        ...
        try:
            validated = AI_ARTWORKConfig(**imported)
